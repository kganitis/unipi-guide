...
1. Κατεβάστε το αρχείο `WindowsFormsApp2023_Final-1.0.1.zip` από τη σελίδα [Releases](https://github.com/kganitis/WindowsFormsApp2023_Final/releases/tag/v1.0.0).
...
Στα αρχεία του [Release](https://github.com/kganitis/WindowsFormsApp2023_Final/releases/tag/v1.0.0). μπορείτε να βρείτε και το βίντεο παρουσίασης της εφαρμογής μας.
